...
const variants = {
  open: { height: '100vh' },
  closed: { height: 64, transition: { damping: 200, delay: 0.4 }, overflow: 'hidden' }
}
          ...
          {smDown && (
            navSections.map(section => (
              <motion.div
                ...
                style={{ textDecoration: 'none', color: 'black', fontSize: '1.35rem', fontWeight: 600, textAlign: 'center' }}>
                {section}
              </motion.div>
            ))
          )}
